  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-blue-800">NiveshSahayak Financial Report</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Profitability Analysis</h2>
          
          <div className="mb-6">
            <div className="flex justify-between mb-2">
              <span className="font-medium">Your Net Profit Margin</span>
              <span className={`font-bold ${profitMargin >= industryAvgMargin ? 'text-green-600' : 'text-red-600'}`}>
                {profitMargin}%
              </span>
            </div>
          ...
          <div className="border-t pt-4">
            ...
            <p className="text-sm text-gray-600">
              You need <span className="font-bold">₹82,500</span> monthly revenue to cover expenses.
            </p>
            <div className="mt-3 bg-yellow-50 p-3 rounded text-sm">
              <span className="font-medium">Current:</span> ₹1,12,000 (+₹29,500 above break-even)
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">AI-Driven Recommendations</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Expense Optimization */}
          <div>
            <h3 className="font-medium text-blue-700 mb-2">Expense Optimization</h3>
          ...
          <div>
            <h3 className="font-medium text-blue-700 mb-2">Growth Opportunities</h3>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                <span className="text-green-500 mr-2">+</span>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">Reimbursements Status</h2>
